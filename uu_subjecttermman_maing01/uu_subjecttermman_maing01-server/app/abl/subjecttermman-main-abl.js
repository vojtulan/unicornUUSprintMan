...
const Errors = require("../api/errors/subjecttermman-main-error.js");
...
const logger = LoggerFactory.get("SubjecttermmanMainAbl");
...
class SubjecttermmanMainAbl {
  ...
  async init(uri, dtoIn, session) {
    ...
    // HDS 2
    const schemas = ["subjecttermmanMain"];
    ...
    if (dtoIn.uuBtLocationUri) {
      ...
      const createAwscDtoIn = {
        name: "UuSubjecttermman",
        typeCode: "uu-subjecttermman-maing01",
        location: location,
